      ...
      <div className="container">
        <div className="gratis__inner">
          ...
          <div className="gratis__content">
            ...
            <div className="gratis__features">
              <div className="gratis__feature">
                <div className="gratis__feature-icon">✓</div>
            ...
            <form className="gratis__form" onSubmit={handleSubmit}>
              <input
                type="text"
